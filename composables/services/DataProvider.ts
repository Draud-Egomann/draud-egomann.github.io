...
export class DataProvider {
  ...
  static GetFlipCards = (t: (key: string) => string): FlipCardItem[] => [
    new FlipCardItem("/imgs/flipCards/violet.jpg", t('about.components.flipCardsFrontTextes[0]')),
    new FlipCardItem("/imgs/flipCards/game.jpg", t('about.components.flipCardsFrontTextes[1]')),
    new FlipCardItem("/imgs/flipCards/wolf.jpg", t('about.components.flipCardsFrontTextes[2]')),
    new FlipCardItem("/imgs/flipCards/winter.jpg", t('about.components.flipCardsFrontTextes[3]'))
  ];
  ...
  static GetContactCards = (): AccordionItem[] => [
    new AccordionItem(
      "E-Mail",
      "text",
      "justin-urbanek@posteo.net",
    ),
    new AccordionItem(
      "LinkedIn",
      "link",
      "https://www.linkedin.com/in/ju-urbanek/",
    ),
    new AccordionItem(
      "GitHub",
      "link",

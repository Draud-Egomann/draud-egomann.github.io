      ...
      <div class="w-full text-white text-center text-5xl font-bold">
        ...
        >
          ...
          >
            ...
            <img
              :src="word.ImageUrl"
              :alt="word.ImageAltText ?? ''"
              :class="word.ImageClass"
        ...
        <div
          v-else
          class="relative inline-grid align-middle w-60 h-12 bg-gray-300 rounded animate-pulse"
        ></div>
      </div>

      <Button
        v-if="!stringHelper.IsNullOrEmpty(buttonText)"
        @click="OnClick"

    ...
    <div class="flex flex-col sm:flex-row justify-between items-center container px-8 py-4 mx-auto">
      ...
      <div class=" flex items-center gap-8">
        <NuxtLink :to="localePath('/references')" class="cursor-pointer"
          :aria-label="$t('footer.referencesAriaLabel')">
          <fa-icon icon="book" class="text-white fa-2x" />
        </NuxtLink>

        <NuxtLink to="https://www.linkedin.com/in/ju-573795244" target="_blank" rel="nofollow" class="cursor-pointer"
          :aria-label="$t('footer.referencesGithub')">
          <svg class="w-8" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
        ...
        <NuxtLink to="https://github.com/Egomann88" target="_blank" rel="nofollow" class="cursor-pointer"
          :aria-label="$t('footer.referencesLinkedin')">

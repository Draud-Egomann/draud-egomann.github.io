  ...
  <div :class="height" class="w-full px-8 relative bg-heroBanner">
    <div class="h-full flex flex-col justify-center items-center md:items-baseline gap-8 container mx-auto">
      <div class="w-full flex flex-col gap-4 py-4">
        <h1 class="font-extrabold text-white text-center lg:text-left text-3xl lg:text-4xl my-2">
          {{ title }}
        </h1>

        <h2 class="font-bold text-white text-center lg:text-left text-2xl lg:text-3xl my-2">
          {{ subTitle }}
        </h2>

        <p v-for="paragraph in paragraphs" class="w-full lg:max-w-md text-center lg:text-left text-white">
          {{ paragraph }}
        </p>
